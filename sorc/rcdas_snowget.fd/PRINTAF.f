c     SUBROUTINE PRINTAF ( SNODEP ) 
      SUBROUTINE PRINTAF ( SNODEP, MSKAF ) 
C
...
c     INTEGER       IPSNO(512)
      INTEGER       MSKAF (512,512), IPSNO(512)
C                                                                       
...
c     print 70, j, (mskaf(i,j), i=1,iaf)
c     print 70, j, (mskaf(i,j), i=175,189)
   70 FORMAT(' ', ' J=', I3, 1X, 74I1)
c  70 format(' ', ' J=', i3, 1x, 512i1)
c  70 format(' ', ' J=', i3, 1x, 15i1)
  100 CONTINUE
C
      PRINT 120
...
C FORCE PRINT OF ASTERISK FOR OFF-WORLD
  ...
  150 CONTINUE    
      PRINT 71, J, (IPSNO(I), I=69,IAF,6)
   71 FORMAT(' ', ' J=', I3, 1X, 74I1)
  200 CONTINUE
C
      RETURN
      END
