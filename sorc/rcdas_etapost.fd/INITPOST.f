...
C
      ENVAR=' '
      CALL get_environment_variable("RSTFNL",ENVAR)
...
!          V10(I,J)=V(I,J,LM)
        ...
        WMSK=VTM(I+IHE(J),J,LM)+VTM(I+IHW(J),J,LM)
     1                         +VTM(I,J+1,LM)+VTM(I,J-1,LM)

        IF(WMSK.GT.0.)THEN
          RWMSK=1./WMSK
          U10(I,J)=(U(I+IHE(J),J,LM)*VTM(I+IHE(J),J,LM)
     1             +U(I+IHW(J),J,LM)*VTM(I+IHW(J),J,LM)
     2             +U(I,J+1,LM)*VTM(I,J+1,LM)+U(I,J-1,LM)*VTM(I,J-1,LM))
     3             *RWMSK
          V10(I,J)=(V(I+IHE(J),J,LM)*VTM(I+IHE(J),J,LM)
     1             +V(I+IHW(J),J,LM)*VTM(I+IHW(J),J,LM)
     2             +V(I,J+1,LM)*VTM(I,J+1,LM)+V(I,J-1,LM)*VTM(I,J-1,LM))
     3             *RWMSK
        ELSE
          U10(I,J)=0.
          V10(I,J)=0.
