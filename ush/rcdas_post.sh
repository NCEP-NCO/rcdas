...
cp $FIXrcdas/cntrl.parm                 cntrl.parm
cp $FIXrcdas/nhb3245                    nhb3245
...
for tmmark in tm12 tm09 tm06 tm03 ; do
  ...
  restart00=$COM/${model}.t${hr}z.restrt00
  restart03=$COM/${model}.t${hr}z.restrt03
  egrd00=$COM/${model}.t${hr}z.egrdsf00
  egrd03=$COM/${model}.t${hr}z.egrdsf03
  awip00=$COM/${model}.t${hr}z.awip3200
  awip03=$COM/${model}.t${hr}z.awip3203
  merged=${model}.t${hr}z.awip32.merged
  merged_grb2=${model}.t${hr}z.awip32.merged.grb2

  # bufr soundings are turned off
  # snding=$COM/${model}.t${hr}z.class1.bufr
  ...
  cp $FIXrcdas/inval.${tmmark}.post    post0.parm
  ...
  for fhr in 00 03 ; do
    ...
    startmsg
    ${EXECrcdas}/rcdas_etapost < $FIXrcdas/edspost.${fhr}.parm > outmeso.out${fhr}.${tmmark}
    err_chk
...
#   prepout=$COM/${model}.t${hr}z.prepout
...
#   ges=$COM/${model}.t${hrges}z.awip3203
#   [ $hrges -eq 21 ] && ges=$COM_M12/${model}.t21z.awip3203
#   prevent=$COM/${model}.t${hr}z.fits_ges.bufr_d
#   postvent=$COM/${model}.t${hr}z.fits_anl.bufr_d
...
#
#      startmsg
#      $EXECrcdas/rcdas_editbufr < $FIXrcdas/keeplist.eta
#      err_chk
#
#      pgm='rcdas_prepfits'
#      . prep_step
#      clean_unit
#      export FORT11=$FIXrcdas/levcat.eta
#      export FORT20=data00
#      export FORT22=$FIXrcdas/prepfits.tab
...
#      export FORT20=$FIXrcdas/grid#104
#      export FORT21=$FIXrcdas/regions
#      export FORT51=$COM/${model}.t${hr}z.vdb.f00
#
#      startmsg
#      $EXECrcdas/rcdas_gridtobs < $FIXrcdas/gridtobs.eds0012a.opn > gridtobs.${hr}_00.out
#      err_chk
#      if [ "$SENDCOM" = 'YES' ] ; then
...
#      export FORT20=$FIXrcdas/grid#104
#      export FORT21=$FIXrcdas/regions
#      export FORT51=$COM/${model}.t${hr}z.vdb.f03
#
#      startmsg
#      $EXECrcdas/rcdas_gridtobs < $FIXrcdas/gridtobs.eds0012a.opn > gridtobs.${hr}_03.out
#      err_chk
#
#      if [ "$SENDCOM" = 'YES' ] ; then
...
[ $HR -eq 9 ] && HR='09'
if [ "$SENDCOM" = 'YES' ] ; then
   touch $COM/${model}.t${HR}z.status_post
fi
